...
Vamos a estudiar varios métodos distintos basados en distancias. El
primero de ellos, conocido como Local Outlier Factor, se se basa en la
idea del vecino más cercano. El resto de métodos son modificaciones de
algoritmos clásicos de clustering,
